...
class UI:
    def __init__(self):
        ...
        self.canvas = sg.Graph(canvas_size=[SIZE_X * 2, SIZE_Y * 2],
        ...
        while True:
            ...
            if event in (None, "Exit"):
                ...
                angle = self.direction.submit_bearing(values["northing"], values["degree"],
                                                      values["minute"],
    ...
    def draw_vector(self):
        ...
        self.canvas.draw_arc(top_left=(-50, 50), bottom_right=(50, -50), start_angle=90,
                             extent=angle * -1,
                             arc_color='green')
